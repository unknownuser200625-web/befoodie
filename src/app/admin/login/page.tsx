...
export default function LoginPage() {
        ...
        const check = async () => {
            ...
            if (result.ok && result.data) {
                ...
                if (result.data.authenticated) {
                    router.push(result.data.role === 'owner' ? '/admin' : '/kitchen');
                }
            }
        };
        check();
    ...
    // Clear state when switching roles to prevent autofill leak
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (result.ok) {
                router.push(type === 'owner' ? '/admin' : '/kitchen');
                router.refresh();
            } else {
                ...
                <div className="w-full max-w-md">
                    <div className="bg-[#121212] border border-white/10 rounded-3xl p-8 shadow-2xl overflow-hidden relative">
                        ...
                        <div className="relative z-10">
                            ...
                            <h1 className="text-3xl font-black text-center mb-2 tracking-tighter">BROASTIFY SECURE</h1>
